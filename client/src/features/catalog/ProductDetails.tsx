...
export default function ProductDetails() {
    ...
    return (
        <Grid spacing={6} container>
            <Grid item xs={6}>
                <img src={product.pictureUrl} alt={product.name} style={{ width: "100%", height:"500px" }} />
            </Grid>
            <Grid item xs={6}>
                <Typography variant="h3">{product.name}</Typography>
                <Divider sx={{ mb: 2 }} />
                <Typography color="secondary" variant="h4">${(product.price / 100).toFixed(2)}</Typography>
                <TableContainer>
                    <Table>
                        <TableBody>
                            <TableRow>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <LoadingButton onClick={handleUpdateCart}
                            ...
                            loading={submitting} sx={{ height: "55px" }}
